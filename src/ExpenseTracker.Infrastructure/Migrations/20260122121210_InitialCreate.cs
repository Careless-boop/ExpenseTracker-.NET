    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpenseListMembers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExpenseListMembers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExpenseListMembers_ExpenseLists_ExpenseListId",
                        column: x => x.ExpenseListId,
                        principalTable: "ExpenseLists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Settlements_ExpenseLists_ExpenseListId",
                        column: x => x.ExpenseListId,
                        principalTable: "ExpenseLists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseListMembers_ExpenseListId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseListMembers_UserId",
                table: "ExpenseListMembers",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Settlements_ExpenseListId",
                table: "Settlements",
                column: "ExpenseListId");
